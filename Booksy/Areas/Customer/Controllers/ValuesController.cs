...
namespace Booksy.Areas.Customer.Controllers
{
    ...
    public class ValuesController : ControllerBase
    {
        ...
        public ValuesController(IProductRepository productRepository, IRepository<Category> categoryRepository)
        {
        ...
        [HttpGet("")]
        public async Task<IActionResult> Index(ProductFilterRequest productFilterRequest, int page = 1)
        {
            const double discount = 50;
            var products = (await _productRepository.GetAsync(includes: [e=>e.Category])).AsQueryable();
        ...
        public async Task<IActionResult> Details([FromRoute] int id)
        {
            ...
            // Return Data
            ProductWithRelatedResponse productWithRelatedResponse = new()
            {
                Product = product,
            ...
            return Ok(productWithRelatedResponse);
        }
    }
}
